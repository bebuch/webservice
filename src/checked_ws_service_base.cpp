...
#include "checked_ws_service_base_impl.hpp"
...
namespace webservice{
	...
	checked_ws_service_base::checked_ws_service_base()
		: impl_(std::make_unique< checked_ws_service_base_impl >(*this)){}


	checked_ws_service_base::~checked_ws_service_base() = default;


	void checked_ws_service_base::on_open(
		std::uintptr_t const /*identifier*/,
		std::string const& /*resource*/){}

	void checked_ws_service_base::on_close(
		std::uintptr_t const /*identifier*/,
		std::string const& /*resource*/){}
