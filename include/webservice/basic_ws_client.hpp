...
namespace webservice{
	...
	public:
		...
		void send_text(SendTextType data){
			...
			ws_client_base::send_text(buffer, std::move(keep_alive));
		}
		...
		void send_binary(SendBinaryType data){
			...
			auto keep_alive = std::make_shared< boost::any >(std::move(data));
			ws_client_base::send_binary(buffer, std::move(keep_alive));
		}
	...
	to_const_buffer_t< SendTextType > basic_ws_client<
		SendTextType,
		SendBinaryType,
		ReceiveTextType,
	...
	template <
		...
		typename ReceiveTextType,
		typename ReceiveBinaryType >
	to_const_buffer_t< SendBinaryType > basic_ws_client<
		SendTextType,
		SendBinaryType,
		ReceiveTextType,
